    ...
    return (
        <div >
            ...
            <div className='inline-block p-8 border border-blue-300  ' >
                ...
                <input name='title' onChange={handleChange} value={formData.title}  className='p-1 w-[600px] border border-black rounded-md' type="text" placeholder='Enter Title' />
                </div>
              <div className='my-3'>
              <label className='font-bold' htmlFor="">Author</label><br />
              <input name='author' onChange={handleChange} value={formData.author}   className='p-1 w-[600px] border border-black rounded-md' type="text" placeholder='Author Name' />
              </div>
               <div className='my-3'>
               <label className='font-bold' htmlFor="">Year</label><br />
               <input name='year'  onChange={handleChange} value={formData.year}  className='p-1 w-[600px] border border-black rounded-md' type="number" placeholder='Enter Year of Publishing' /><br />
